...
namespace FundamentalsofProgramming.Session_02
{
    internal class Ex_02
    {
        ...
        { 
            ...
            //24. Find Longest Word in String: Write a C# program to find the longest word in a string. using System.ComponentModel;
            Console.Write("Enter a string: ");
